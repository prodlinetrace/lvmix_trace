from .constants import PC_READY_FLAG, PLC_QUERY_FLAG, PLC_SAVE_FLAG, DB_BUSY_FLAG, PC_OPEN_BROWSER_FLAG, STATION_ID, PRODUCT_TYPE, SERIAL_NUMBER, DATE_TIME, PLC_HEARTBEAT_FLAG, PC_HEARTBEAT_FLAG, TRC_TMPL_COUNT, STATION_NUMBER, STATION_STATUS, PLC_TRC_ON, PROGRAM_NAME, PROGRAM_NUMBER, CHECKSUM
...
82.6   ctrl.PC_reserve_2            BOOL        # not used
82.7   ctrl.PC_reserve_3            BOOL        # not used
