...
db300 = """
0.0    ctrl.plc_live         BOOL
0.1    ctrl.plc_trc_on       BOOL
0.2    ctrl.plc_data_ready   BOOL
0.3    ctrl.plc_reserve      BOOL
0.4    ctrl.pc_live          BOOL
0.5    ctrl.pc_trc_on        BOOL
0.6    ctrl.pc_data_ready    BOOL
0.7    ctrl.pc_reserve       BOOL
1.0    ctrl.reserve          BYTE
2.0    head.size             INT
4.0    head.station_id       BYTE
5.0    head.frame_id         BYTE
6.0    head.product_type     STRING[12]
20.0   head.serial_number    STRING[8]
30.0   head.week_number      STRING[4]
36.0   head.year_number      STRING[4]
42.0   head.timestamp        DATE_AND_TIME
50.0   body.prev_station_id  BYTE
51.0   body.reserve          BYTE
52.0   tail.checksum         DINT
"""
